...
anão.male = function() {this.name(male)}
anão.female = function() {this.name(female)}
...
elf.male = function() {this.name(male)}
elf.female = function() {this.name(female)}
elf.neutral = function() {this.name(neutral)}
...
gnome.male = function() {this.name(male)}
gnome.female = function() {this.name(female)}
gnome.neutral = function() {this.name(neutral)}
...
goblin.male = function() {this.name(male)}
goblin.female = function() {this.name(female)}
...
halfling.male = function() {this.name(male)}
halfling.female = function() {this.name(female)}

const meio_elfo = {}
meio_elfo.name = function (type) {
...
meio_elfo.male = function() {this.name(male)}
meio_elfo.female = function() {this.name(female)}
...
meio_orc.male = function() {this.name(male)}
meio_orc.female = function() {this.name(female)}
...
ancestry.male = function() {
  this.print(male)
}
ancestry.female = function() {
  this.print(female)
}
